...
1. **Welcome screen — "Royal Video Poker."** A fan of playing cards, a tagline about playing with free chips ("no real money, all the thrill"), and three quick pills summarizing the game: 5-Card Draw, Free Chips Daily, No Real Money. The app picks the device's language automatically on first launch, and a globe chip in the corner of this screen lets the player change it — sixteen languages: English, Spanish, Portuguese (Brazil), German, French, Italian, Polish, Russian, Turkish, Indonesian, Hindi, Japanese, Korean, Simplified Chinese, Hebrew, and Arabic. Hebrew and Arabic mirror the entire interface right-to-left. It can also be changed later under Settings.
